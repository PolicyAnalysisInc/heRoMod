...
*   **Documentation & Examples (Phase 7):** IN PROGRESS - Initial Sphinx setup, API stubs, getting started tutorial, and detailed examples for all core analyses completed. Topical guides ("Defining Parameters", "Simulation Outputs", "PSA Workflow", "DSA Workflow", "Calibration Workflow", "VoI Guide", "VBP Guide", "Scenario Analysis Guide", "Model Types Comparison Guide", "Customizing Plots Guide") drafted. API docstring enhancements for key modules applied. This completes the initial planned set of topical guides.
*   **Next Up (Phase 6 Continued):** Focus on full individual-level simulation.
*   **Next Up (Phase 7 Continued):** Full API doc generation and actual build/review, further docstring refinements for all modules based on rendered output.
