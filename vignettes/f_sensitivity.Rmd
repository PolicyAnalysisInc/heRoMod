...
This example uses the HIV drug model defined in `vignette("e-probabilistic", "heRomod")`. See this vignette for an explanation of the model. Note that as in PSA, parameters need to be defined in `define_parameters()` in order to be modified in a DSA.
