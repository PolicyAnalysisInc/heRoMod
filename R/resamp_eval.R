...
#'   
run_psa <- function(model, psa, N, resample, cores = 1, create_progress_reporter = create_null_prog_reporter, progress_reporter = create_progress_reporter(), simplify = F) {
  if (! missing(resample)) {
